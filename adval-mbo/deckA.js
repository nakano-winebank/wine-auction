...
[['中野陣営','50.000%','中野邦人 74,000株（SO行使後）＋ 中野ファンド 61,180株',C.ACC2],
 ['パートナー','50.000%','135,180株（東京建物等の芙蓉グループを想定）','8FB0CC']]
.forEach((r,i)=>{
  const x=1.0+i*5.85;
...
tbl(s,[
 ...
 [{text:'パートナー',options:{bold:true}},{text:'135,180 株',options:{align:'right'}},
  {text:'50.000%',options:{align:'right',bold:true,color:C.BLUE}},{text:'13.47 億円',options:{align:'right',bold:true}},'東京建物等の芙蓉グループを想定'],
...
[['01','グループのエクイティ機能のご紹介','パートナー13.47億円の引受先として、東京建物等の芙蓉グループに加え、みずほキャピタル様やみずほグループのファンドをご紹介いただけないでしょうか。本件で最もお願いしたい点です。なお12億円を下回ると債務超過を解消しきれず、規模を縮小した折衷案は成立しません。','13.47億円'],
