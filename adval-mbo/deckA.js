...
[['何を','ビジョン社ほか既存株主7社の全株式','20億円評価・現金対価',C.INK],
 ['いくら','増資 19.57億円','中野ファンド6.12億＋パートナー13.44億',C.ACC],
...
[['① エクイティ13.44億円の引受先のご紹介','みずほキャピタル様・グループファンドを含めて'],
...
[{x:0.7,t:'① 第三者割当増資',a:'19.57億円',b:'中野ファンド 6.12億\nパートナー 13.44億',hi:1},
...
T(s,'取引後の株主は2者・中野陣営が単独筆頭',{x:1.0,y:4.8,w:6,h:0.35,fontSize:15,bold:true,color:C.WHITE});
[['中野陣営','50.100%','中野邦人 74,000株（SO行使後）＋ 中野ファンド 61,451株',C.ACC2],
 ['パートナー','49.900%','134,909株（ヒューリック／東京建物等を想定）','8FB0CC']]
.forEach((r,i)=>{
  const x=1.0+i*5.85;
...
tbl(s,[
 ...
 [{text:'中野ファンド',options:{bold:true}},{text:'61,451 株',options:{align:'right'}},
  {text:'22.729%',options:{align:'right',bold:true}},{text:'6.12 億円',options:{align:'right',bold:true}},'新規設立・中野がGP'],
 [{text:'　中野陣営 計',options:{bold:true,fill:'F3E7EA'}},{text:'135,451 株',options:{align:'right',bold:true,fill:'F3E7EA'}},
  {text:'50.100%',options:{align:'right',bold:true,color:C.ACC,fill:'F3E7EA'}},
  {text:'6.12 億円',options:{align:'right',bold:true,fill:'F3E7EA'}},{text:'',options:{fill:'F3E7EA'}}],
 [{text:'パートナー',options:{bold:true}},{text:'134,909 株',options:{align:'right'}},
  {text:'49.900%',options:{align:'right',bold:true,color:C.BLUE}},{text:'13.44 億円',options:{align:'right',bold:true}},'ヒューリック／東京建物等を想定'],
...
[['01','グループのエクイティ機能のご紹介','パートナー13.44億円の引受先として、ヒューリック・東京建物に加え、みずほキャピタル様やみずほグループのファンドをご紹介いただけないでしょうか。本件で最もお願いしたい点です。','13.47億円'],
...
[['STEP 1','無償減資・欠損填補','資本金・資本準備金を取り崩し、繰越欠損金△10.62億を填補。分配可能額をつくります。',C.ACC],
 ['STEP 2','第三者割当増資 19.57億円','中野ファンド6.12億・パートナー13.44億。払込により債務超過が解消します。',C.ACC],
...
p.writeFile({fileName:'あどばるMBO_ご提案_20260924.pptx'}).then(()=>console.log('deckA written'));
