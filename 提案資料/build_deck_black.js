...
/* 5 STRUCTURE — 2契約 */{
  ...
  s.addText("賃貸借契約は締結しません。所有権は会員のまま、当社は保管・保険・真正性管理と、売却時の成功報酬を担います。",
...
/* 11 TWO TRACKS + 年次精算 */{
  const s=base("TWO TRACKS","運用型を基本に。ただし「飲みたい」も、無理なく受け止める。",
    "飲むつもりの人に成果報酬は不要です。そして運用型の人も、途中で飲みたくなります。");
  [["運用型（推奨・基本）","売買・管理 ＋ 成果報酬",["所有権は会員のまま。当社が保管・保険・管理","マイルは管理料に対するおまけ（無償）","値上がりの70〜75%は会員のもの。出口は自由"],PANEL2,GOLD],
   ["消費型（自己利用・贈答）","売買 ＋ 寄託のみ",["成果報酬はかからない","マイルは購入時の還元として付与","規制の表面積はほぼゼロ"],PANEL,MINT]
  ].forEach((c,i)=>{
...
/* 19 RISK */{
  const s=base("LEGAL","法務確認済み：実施できます",
    "岩田合同法律事務所より2026年9月20日にクリーンオピニオンを取得。「対価性の要件を充足する事情は不見当」との結論です。");
  [["資金決済法","二重の安全弁がかかっています",
    "① 管理料に対するおまけ（無償発行）のため、前払式支払手段の対価性要件を満たしません。② 仮に該当しても、有効期限が発行から6ヶ月以内なら届出・供託・帳簿・報告の義務が生じません（法4条2号）。期間限定マイルは②も満たします。"],
   ["出資法・銀行法","そもそも該当しない",
...
/* 21 ROADMAP */{
  ...
  [["PHASE 0","〜2ヶ月","土台を固める",["店舗原価率と90%精算の合意","弁護士意見書（取得済）","売買・管理規約と成果報酬契約の整備","交流イベントの年間計画"]],
...
/* 22 NEXT */{
  ...
  [["WineBank CLUBの実数","ランク別の年会費・特典・提携店数。BLACKの特典内容がSIGNATUREの購買動機を決めます。"],
   ...
   ["残る法務・税務の宿題","①マイル利用規約の整備（経産省ガイドラインの6項目）②成果報酬契約の文言 ③無償付与マイルの課税整理（税理士）④古物競りあっせん業者の届出要否"]
  ].forEach((v,i)=>{
